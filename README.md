## Hey there 👋, I'm [Montassar!](https://github.com/Montassar90/)

[![Linkedin Badge](https://img.shields.io/badge/-LinkedIn-0e76a8?style=flat-square&logo=Linkedin&logoColor=white)](https://www.linkedin.com/in/montassarbahria/)

### Glad to see you here! 

I am a QA Engineer with a strong dual expertise in manual and automated testing, passionate about delivering high-quality software and seamless user experiences. 🔍💻

With experience in Agile environments, I design and implement end-to-end tests that ensure functionality and reliability across web applications.

I specialize in tools and technologies such as Selenium WebDriver, Java, Cucumber, JUnit/TestNG, Postman, Cypress and Playwright, while also applying manual testing best practices for exploratory, regression, and user acceptance testing. I actively contribute to CI/CD pipelines and collaborate closely with developers and product teams to integrate quality throughout the development lifecycle.

Driven by curiosity and a strong sense of ownership, I constantly seek to improve test coverage, reduce feedback loops, and prevent issues before they reach production. My goal is to combine critical thinking with technical skill to ensure that each release meets the highest standards of quality.
